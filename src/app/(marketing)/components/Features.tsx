...
const features = [
  {
    id: 1,
    icon: <IconSearch className="text-primary-500" />,
  ...
  {
    id: 2,
    icon: <IconSpeakerphone className="text-primary-500" />,
  ...
  {
    id: 3,
    icon: <IconWorld className="text-primary-500" />,
    title: "Go global",
  ...
  {
    id: 4,
    icon: <IconForms className="text-primary-500" />,
  ...
  {
    id: 5,
    icon: <IconWriting className="text-primary-500" />,
  ...
  {
    id: 7,
    icon: <IconSitemap className="text-primary-500" />,
    title: "Knowledge base",
    description: "In aliquet malesuada consectetur in enim eu maecenas suspendisse. Elementum at enim consequa.",
  },
  {
    id: 8,
    icon: <IconJson className="text-primary-500" />,
    title: "Structured schema markups",
    description: "In aliquet malesuada consectetur in enim eu maecenas suspendisse. Elementum at enim consequa.",
  },
  {
    id: 9,
    icon: <IconSeo className="text-primary-500" />,
    title: "Programmatic SEO",
    description: "In aliquet malesuada consectetur in enim eu maecenas suspendisse. Elementum at enim consequa.",
  },
  {
    id: 10,
    icon: <IconBrandYoutube className="text-primary-500" />,
    title: "Youtube to content",
    description: "In aliquet malesuada consectetur in enim eu maecenas suspendisse. Elementum at enim consequa.",
  },
  {
    id: 11,
    icon: <IconCode className="text-primary-500" />,
    title: "Embed Youtube videos",
    description: "In aliquet malesuada consectetur in enim eu maecenas suspendisse. Elementum at enim consequa.",
  },
  {
    id: 12,
    icon: <IconLink className="text-primary-500" />,
    title: (
      <Flex gap={6}>
  ...
  {
    icon: <IconLayoutCollage className="text-primary-500" />,
    title: (
      <Flex gap={6}>
...
const Features = () => {
  return (
    <section id="features" className="container flex flex-col mx-auto items-center gap-6 px-40">
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="font-light text-zinc-600 w-1/2 mx-auto text-center mb-8">
