...
import { Button, Card, Col, Flex, Row, Switch, Tabs, Tag, Typography } from "antd";
import { useEffect, useState } from "react";
import { useProducts, PaymentModal, CustomerPortal, CustomerProfile, Subscriptions, PaymentMethods, InvoicesHistory, Product } from "@billing-js/react-billing-js";
                  ...
                  <Flex vertical gap="middle">
                    <Flex justify="start" gap="middle">
                      ...
                      <Flex gap="small">
                        ...
                        <Tag color={selectedRecurrence?.name === "yearly" ? "#5d5fef" : undefined}>40% off</Tag>
                      </Flex>
                    </Flex>
                          ...
                          <Card key={product.id} style={{ width: 350 }}>
                            <Flex vertical>
                              <Flex align="center" gap="small" style={{ marginBottom: 4 }}>
                                <Typography.Text strong style={{ fontSize: 22 }}>{product.name}</Typography.Text>
                              ...
                              <Flex vertical gap="large">
                                ...
                                {isActivePlan ? (
                                  <Button size="large" disabled>Cancel plan</Button>
                                ) : (
                                  <Button size="large" onClick={product.selectedPricing.onSelectPricing}>Switch plan</Button>
  ...
  return (
    <div>
      ...
      <BillingProvider
        ...
        onCustomerSignedIn={() => console.log("onCustomerSignedIn")}
